...
// export default function RelatedBlogs({ pageName, blogs, maxDisplay = 3 }: RelatedBlogsProps) {
//   const filteredBlogs = blogs
//     .filter((blog) => blog.pageName === pageName && blog.isPublished)
//     .slice(0, maxDisplay);
...
//   return (
//     <section className="py-[var(--section-py)] bg-[var(--color-section-alt)] border-t border-[var(--color-border)]">
//       <div className="max-w-[1280px] mx-auto px-[var(--container-padding)]">
//         <div className="flex items-end justify-between mb-8">
//           <div>
//             <span className="inline-block px-3 py-1 rounded-full bg-[var(--color-badge-bg)] border border-[var(--color-badge-border)] text-[var(--color-badge-text)] text-sm font-medium mb-3">
//               From the Blog
//             </span>
...
//                   </span>
//                 </div>
//                 <h3 className="font-semibold text-[var(--color-text-primary)] text-base mb-2 group-hover:text-[var(--color-primary)] transition-colors line-clamp-2">
//                   {blog.title}
//                 </h3>
//                 {blog.excerpt && (
