...
import { disconnectFacebookAccount, getFacebookLivePosts } from "@/store/social-media/social-media/socialMedia";
...
export function createFacebookModule(): PlatformModuleConfig {
  ...
  return {
    ...
    color: "linear-gradient(135deg, var(--color-primary-600), var(--color-primary-800))",
    icon: (
