...
function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-[var(--container-max)] mx-auto px-[var(--container-padding)] h-full flex items-center justify-between">
        <a href="#" className="flex items-center gap-2 font-bold text-xl tracking-tight">
          <div className="w-8 h-8 rounded-lg bg-[#2563eb] flex items-center justify-center">
            <Rocket className="w-5 h-5 text-white" />
          </div>
          <span className="text-[#0f172a]">CreatiKai</span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            href="#pricing"
            className="px-5 py-2.5 rounded-full bg-[#2563eb] text-white text-sm font-semibold hover:bg-[#1d4ed8] transition-all shadow-[0_4px_6px_-1px_rgba(37,99,235,0.2)] hover:shadow-[0_10px_15px_-3px_rgba(37,99,235,0.3)]"
          >
            Enroll Now — $497
          </a>
        </div>
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            <div className="px-[var(--container-padding)] py-4 flex flex-col gap-3">
              {navLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="text-sm font-medium text-[#475569] py-2"
              ...
              <a
                href="#pricing"
                className="mt-2 px-5 py-3 rounded-full bg-[#2563eb] text-white text-sm font-semibold text-center"
                onClick={() => setMobileOpen(false)}
              >
                Enroll Now — $497
              </a>
      ...
      <div className="max-w-[var(--container-max)] mx-auto px-[var(--container-padding)]">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-1">
            <a href="#" className="flex items-center gap-2 font-bold text-xl tracking-tight mb-4">
              <div className="w-8 h-8 rounded-lg bg-[#2563eb] flex items-center justify-center">
                <Rocket className="w-5 h-5 text-white" />
              </div>
              <span className="text-white">CreatiKai</span>
            </a>
            <p className="text-sm text-[#94a3b8] leading-relaxed">
              Empowering marketers with the skills and systems to build world-class social media campaigns.
            </p>
          </div>

          <div>
            <h4 className="text-sm font-semibold text-white mb-4">Course</h4>
            <ul className="space-y-2">
              {["Curriculum", "Pricing", "Success Stories", "FAQ"].map((item) => (
                <li key={item}>
                  <a href={`#${item.toLowerCase().replace(" ", "-")}`} className="text-sm text-[#94a3b8] hover:text-white transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Blog", "Free Guides", "Community", "Support"].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2 text-sm text-[#94a3b8]">
                <Mail className="w-4 h-4" /> support@creatikai.com
              </li>
              <li className="flex items-center gap-2 text-sm text-[#94a3b8]">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-[#64748b]">
            &copy; 2026 CreatiKai. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            {["Privacy", "Terms", "Refund Policy"].map((item) => (
              <a key={item} href="#" className="text-sm text-[#64748b] hover:text-white transition-colors">
                {item}
              </a>
            ))}
          </div>
