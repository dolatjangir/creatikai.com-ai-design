...
export default function SEOLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[url(https://res.cloudinary.com/djipgt6vc/image/upload/v1778580836/seo-login-background-image_nslx6a.png)] bg-cover bg-no-repeat flex items-center justify-center p-4">
      <Link href='/'>
      <div className='absolute left-4 top-4 hidden sm:flex justify-center items-center'>
        <img src="/creatikai-logo.png" className='w-[40px] h-[50px] sm:w-[60px] sm:h-[70px]'/><h1 className='font-bold text-xl sm:text-2xl'>Creatik <span className='text-[var(--color-primary)]'>Ai</span></h1>
      </div></Link>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">CreatikAi SEO Manager</h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@creatikai.com"
                />
              </div>
            </div>
