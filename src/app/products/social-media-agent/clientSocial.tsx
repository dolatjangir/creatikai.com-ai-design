...
export default function AISocialMediaAgentLanding() {
  ...
  const platforms: Platform[] = [
    { name: 'Instagram', icon: <FaInstagram className="w-6 h-6" />, color: '#E4405F', bgColor: 'bg-pink-500' },
    { name: 'Twitter', icon: <FaTwitter className="w-6 h-6" />, color: '#1DA1F2', bgColor: 'bg-sky-500' },
    { name: 'LinkedIn', icon: <FaLinkedin className="w-6 h-6" />, color: '#0A66C2', bgColor: 'bg-blue-700' },
    { name: 'Facebook', icon: <FaFacebookF className="w-6 h-6" />, color: '#1877F2', bgColor: 'bg-blue-600' },
    { name: 'YouTube', icon: <FaYoutube className="w-6 h-6" />, color: '#FF0000', bgColor: 'bg-red-600' },
  ];
