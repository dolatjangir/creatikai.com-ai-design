          ...
          <div className="anim-scale-in delay-300 relative rounded-3xl bg-white border-2 border-[#2563eb] shadow-xl overflow-hidden">
            ...
            <div className="p-8 md:p-12 text-center">
              ...
              <div className="flex items-end justify-center gap-2 mb-2">
                <span className="text-5xl md:text-6xl font-extrabold text-[#0f172a]">$997</span>
                <span className="text-lg text-[#94a3b8] line-through mb-2">$4,997</span>
              </div>
              <p className="text-sm text-[#10b981] font-semibold mb-8">Save $4,000 — Limited Time Offer</p>
